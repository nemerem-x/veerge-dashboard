  ...
  return (
    ...
    >
      <div className="flex flex-col gap-2 items-start justify-start shrink-0 relative">
        <div className="rounded-[100px] p-2 flex flex-row gap-1 items-start justify-start shrink-0 relative">
          <svg
          ...
          >
            <path
              ...
              stroke="url(#paint0_linear_4733_1448)"
              strokeWidth="2.7"
              strokeMiterlimit="10"
            />
            <path
              ...
              stroke="url(#paint1_linear_4733_1448)"
              strokeWidth="2.7"
              strokeMiterlimit="10"
            />
            <path
              ...
              fill="url(#paint2_linear_4733_1448)"
            />
            <defs>
              <linearGradient
                id="paint0_linear_4733_1448"
                x1="2.89818"
                y1="8.44539"
                x2="18.1055"
                y2="8.44539"
        ...
        <div className="rounded-[100px] p-2 flex flex-row gap-1 items-start justify-start shrink-0 relative">
          <div className="shrink-0 w-6 h-6 relative overflow-hidden">
            <svg
              className="h-[auto] absolute right-[10.42%] left-[10.42%] w-[79.17%] bottom-[8.08%] top-[8.08%] h-[83.83%] overflow-visible"
              style={{}}
              width="20"
              height="22"
              viewBox="0 0 20 22"
            ...
            >
              <path
                ...
                fill="url(#paint0_linear_4733_1454)"
              />
              <path
                ...
                fill="url(#paint1_linear_4733_1454)"
              />
              <path
                ...
                fill="url(#paint2_linear_4733_1454)"
              />
              <defs>
                <linearGradient
                  id="paint0_linear_4733_1454"
                  x1="2.34182"
                  y1="13.4112"
                  x2="17.6375"
                  y2="13.4112"
        ...
        <div className="rounded-[100px] p-2 flex flex-row gap-1 items-start justify-start shrink-0 relative">
          <div className="shrink-0 w-6 h-6 relative overflow-hidden">
            <svg
              className="h-[auto] absolute right-[8.33%] left-[8.33%] w-[83.33%] bottom-[10.65%] top-[10.65%] h-[78.71%] overflow-visible"
              style={{}}
              width="20"
              height="20"
              viewBox="0 0 20 20"
            ...
            >
              <path
                d="M13.8403 2.92499V9.02499C13.8403 9.41499 13.5303 9.72499 13.1403 9.72499H7.98027C7.59027 9.72499 7.28027 9.41499 7.28027 9.02499V8.05499H2.98027C2.59027 8.05499 2.28027 7.74499 2.28027 7.35499V1.25499C2.28027 0.864993 2.59027 0.554993 2.98027 0.554993H8.14027C8.53027 0.554993 8.84027 0.864993 8.84027 1.25499V2.22499H13.1403C13.5203 2.22499 13.8403 2.54499 13.8403 2.92499Z"
                fill="url(#paint0_linear_4733_1460)"
              />
              <path
                d="M9.59 12.1849H0.7C0.31 12.1849 0 11.8749 0 11.4849V4.55492C0 4.16492 0.31 3.85492 0.7 3.85492H9.59C9.98 3.85492 10.29 4.16492 10.29 4.55492V11.4849C10.29 11.8749 9.98 12.1849 9.59 12.1849Z"
                fill="url(#paint1_linear_4733_1460)"
              />
              <path
                d="M19.3 19.445H0.7C0.31 19.445 0 19.135 0 18.745V6.47496C0 6.08496 0.31 5.77496 0.7 5.77496H19.3C19.69 5.77496 20 6.08496 20 6.47496V18.745C20 19.135 19.69 19.445 19.3 19.445Z"
                fill="url(#paint2_linear_4733_1460)"
              />
              <defs>
                <linearGradient
                  id="paint0_linear_4733_1460"
                  x1="2.27548"
                  y1="5.14244"
                  x2="13.8365"
                  y2="5.14244"
        ...
        <div className="rounded-[100px] p-2 flex flex-row gap-1 items-start justify-start shrink-0 relative">
          ...
          >
            <path
              ...
              fill="url(#paint0_linear_4733_1465)"
            />
            <path
              ...
              fill="url(#paint1_linear_4733_1465)"
            />
            <path
              ...
              fill="url(#paint2_linear_4733_1465)"
            />
            <defs>
              <linearGradient
                id="paint0_linear_4733_1465"
                x1="8.2422"
                y1="13.8522"
                x2="20.5182"
                y2="13.8522"
